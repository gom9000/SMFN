...
public class FunctionPlotter1D
{
     ...
     * @param renderer Il renderer 1D da usare.
    ...
    void plotFunction(
            ...
            Function<Double, D> domainAdapter,
            Function<C, Double> codomainAdapter) 
    {
        ...
        for (int pixelX = 0; pixelX < width; pixelX++) {
            ...
            // 6. Disegna la linea
            if (pixelX > 0) {
                // Semplice clipping per evitare linee verticali infinite tra punti lontani
                if (Math.abs(pixelY - lastPixelY) < renderer.getHeight() * 2) { 
