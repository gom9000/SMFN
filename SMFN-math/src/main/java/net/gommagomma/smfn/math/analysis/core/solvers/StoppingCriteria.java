...
/**
* Definisce il test logico per determinare se una sequenza di iterazioni deve fermarsi.
* Il test si basa sulla distanza (Real) calcolata dal Solutore.
*/
public interface StoppingCriteria
{
	/**
     * Valuta se lo stato corrente dell'iterazione soddisfa il criterio di stop stabilito.
     *
     ...
     * @return true se il processo e' da considerarsi concluso con successo, false altrimenti
     */
