...
public class DiscreteCartesianPlane
{
	...
	public DiscreteCartesianPlane(double leftUpX, double leftUpY, double rightDownX, double rightDownY, int sizeX, int sizeY)
	{
		this.leftUpX = leftUpX; this.leftUpY = leftUpY; 
		this.sizeX = sizeX;
		this.sizeY = sizeY;
		this.d = Math.abs(rightDownX - leftUpX) / sizeX;
		this.plane = new double[sizeX][sizeY][];
